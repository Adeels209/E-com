...
@section('content')
    ...
    <div class="breadcumb-area breadcumb-2 overlay pos-rltv" style="background-image: url()!important; object-fit: cover; object-position: center; background-size: cover; background-position: center">
        <div class="bread-main">
            <div class="bred-hading text-center">
                <h5>Searched Products Grid View</h5> </div>
            <ol class="breadcrumb">
                        ...
                        <div class="shop-total-product-area clearfix mt-35">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade in active " id="grid">
                                    <div class="total-shop-product-grid single-product-append">
