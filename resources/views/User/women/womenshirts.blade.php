                    ...
                    <div class="row">
                        <div class="shop-sidebar">
                                ...
                                <div class="recent-prodcut-wraper total-rectnt-slider">
                                    <div class="single-rectnt-slider">
                                        ...
                                        <div class="single-product recent-single-product">
                                            <div class="product-img">
                                                <div class="single-prodcut-img  product-overlay pos-rltv">
                                                    <a href="single-product.html"> <img alt="" src="{{ URL::to('user_ui/images/product/rp01.jpg') }}" class="primary-image"> <img alt="" src="{{ URL::to('user_ui/images/product/rp02.jpg') }}" class="secondary-image"> </a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="single-product recent-single-product">
                                            <div class="product-img">
                                                <div class="single-prodcut-img  product-overlay pos-rltv">
                                                    <a href="single-product.html"> <img alt="" src="{{ URL::to('user_ui/images/product/rp03.jpg') }}" class="primary-image"> <img alt="" src="{{ URL::to('user_ui/images/product/rp04.jpg') }}" class="secondary-image"> </a>
                                                </div>
                                            </div>
                                            <div class="product-text">
                                                <div class="prodcut-name"> <a href="single-product.html">Copenhagen Spitfire Chair</a> </div>
                                        ...
                                        <div class="single-product recent-single-product">
                                            <div class="product-img">
                                                <div class="single-prodcut-img  product-overlay pos-rltv">
                                                    <a href="single-product.html"> <img alt="" src="{{ URL::to('user_ui/images/product/rp02.jpg') }}" class="primary-image"> <img alt="" src="{{ URL::to('user_ui/images/product/rp03.jpg') }}" class="secondary-image"> </a>
                                                </div>
                                            </div>
                                            <div class="product-text">
                                                <div class="prodcut-name"> <a href="single-product.html">Copenhagen Spitfire Chair</a> </div>
                                        ...
                                        <div class="single-product recent-single-product">
                                            <div class="product-img">
                                                <div class="single-prodcut-img  product-overlay pos-rltv">
                                                    <a href="single-product.html"> <img alt="" src="{{ URL::to('user_ui/images/product/rp04.jpg') }}" class="primary-image"> <img alt="" src="{{ URL::to('user_ui/images/product/rp01.jpg') }}" class="secondary-image"> </a>
                                                </div>
                                            </div>
                                            <div class="product-text">
                                                <div class="prodcut-name"> <a href="single-product.html">Copenhagen Spitfire Chair</a> </div>
                            ...
                            <aside class="single-aside add-aside">
                                <a href="single-product.html"><img src="{{ URL::to('user_ui/images/banner/add.jpg') }}" alt=""></a>
                            </aside>
                            <!--single aside end-->
                        </div>
                    </div>
                                    ...
                                    <div class="total-shop-product-grid">
                                        <div class="col-md-4 col-sm-6 item">
                                            ...
                                            <div class="single-product">
                                                <div class="product-img">
                                                    ...
                                                    <div class="single-prodcut-img  product-overlay pos-rltv">
                                                        <a href="single-product.html"> <img alt="" src="{{ URL::to('user_ui/images/product/01.jpg') }}" class="primary-image"> <img alt="" src="{{ URL::to('user_ui/images/product/02.jpg') }}" class="secondary-image"> </a>
                                                    </div>
                                        ...
                                        <div class="col-md-4 col-sm-6 item">
                                            ...
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <div class="single-prodcut-img  product-overlay pos-rltv">
                                                        <a href="single-product.html"> <img alt="" src="{{ URL::to('user_ui/images/product/03.jpg') }}" class="primary-image"> <img alt="" src="{{ URL::to('user_ui/images/product/04.jpg') }}" class="secondary-image"> </a>
                                                    </div>
                                                    <div class="product-icon socile-icon-tooltip text-center">
                                                        <ul>
                                                            <li><a href="#" data-tooltip="Add To Cart" class="add-cart" data-placement="left"><i class="fa fa-cart-plus"></i></a></li>
                                        ...
                                        <div class="col-md-4 col-sm-6 item">
                                            ...
                                            <div class="single-product">
                                                <div class="product-img">
                                                    ...
                                                    <div class="single-prodcut-img  product-overlay pos-rltv">
                                                        <a href="single-product.html"> <img alt="" src="{{ URL::to('user_ui/images/product/02.jpg') }}" class="primary-image"> <img alt="" src="{{ URL::to('user_ui/images/product/03.jpg') }}" class="secondary-image"> </a>
                                                    </div>
                                                    <div class="product-icon socile-icon-tooltip text-center">
                                                        <ul>
                                                            <li><a href="#" data-tooltip="Add To Cart" class="add-cart" data-placement="left"><i class="fa fa-cart-plus"></i></a></li>
                                        ...
                                        <div class="col-md-4 col-sm-6 item">
                                            ...
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <div class="single-prodcut-img  product-overlay pos-rltv">
                                                        <a href="single-product.html"> <img alt="" src="{{ URL::to('user_ui/images/product/04.jpg') }}" class="primary-image"> <img alt="" src="{{ URL::to('user_ui/images/product/03.jpg') }}" class="secondary-image"> </a>
                                                    </div>
                                                    <div class="product-icon socile-icon-tooltip text-center">
                                                        <ul>
                                                            <li><a href="#" data-tooltip="Add To Cart" class="add-cart" data-placement="left"><i class="fa fa-cart-plus"></i></a></li>
                                    ...
                                    <div class="total-shop-product-list">
                                        ...
                                        <div class="col-md-12 item">
                                            ...
                                            <div class="single-product single-product-list">
                                                <div class="product-img">
                                                    <div class="single-prodcut-img  product-overlay pos-rltv">
                                                        <a href="single-product.html"> <img alt="" src="{{ URL::to('user_ui/images/product/05.jpg') }}" class="primary-image"> <img alt="" src="{{ URL::to('user_ui/images/product/06.jpg') }}" class="secondary-image"> </a>
                                                    </div>
                                                </div>
                                                <div class="product-text prodcut-text-list fix">
                                                    <div class="prodcut-name list-name montserrat"> <a href="single-product.html">Magnetic Force Bralette</a> </div>
                                        ...
                                        <div class="col-md-12 hidden-sm item">
                                            ...
                                            <div class="single-product single-product-list">
                                                <div class="product-img">
                                                    <div class="single-prodcut-img  product-overlay pos-rltv">
                                                        <a href="single-product.html"> <img alt="" src="{{ URL::to('user_ui/images/product/04.jpg') }}" class="primary-image"> <img alt="" src="{{ URL::to('user_ui/images/product/05.jpg') }}" class="secondary-image"> </a>
                                                    </div>
                                                </div>
                                                <div class="product-text prodcut-text-list fix">
                                                    <div class="prodcut-name list-name montserrat"> <a href="single-product.html">Magnetic Force Bralette</a> </div>
