                            ...
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('user.update', $admin->id) }}" method="POST" class="form form-horizontal striped-rows form-bordered">
                                            @csrf
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="projectinput1" class="form-control" placeholder="First Name" name="name" value="{{ $admin->name }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="projectinput3">E-mail</label>
                                                    <div class="col-md-9">
                                                        <input type="text" id="projectinput3" class="form-control" placeholder="E-mail" name="email" value="{{ $admin->email }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="projectinput3">Password</label>
                                                    <div class="col-md-9">
                                                        <input type="password" id="projectinput3" class="form-control" placeholder="E-mail" name="password" value="{{ $admin->password }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="password" id="projectinput3" class="form-control" placeholder="" name="password_confirmation">
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="input-group">
                                                            <div class="d-inline-block custom-control custom-radio mr-1">
                                                                @foreach($rolez as $role)
                                                                    <div class="d-inline-block custom-control custom-radio mr-1">
                                                                        <input type="checkbox" name="role[]" class="" id="yes"  {{ in_array($role->id, $admin->roles->pluck('id')->toArray()) ?'checked' : ''  }} value="{{ $role->id }}">
