                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form id="myForm" class="form" action="{{ route('admin.category.store')}}" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                                            @csrf
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="summernote-code " name="description" id="description" ></textarea>
                                                        </div>
                                                    </div>
                                                </div>
...
@section('extra_scripts')
    ...
    <script>
        ...
        function validateForm() {
            ...
            if (name.length == 0) {
                swal('Not Saved', 'Category Name field is Required', 'error');
                return false
            }
            if (strip(description).trim().length == 0) {
                swal('Not Saved', 'Category Details field is Required', 'error');
                return false
            }
