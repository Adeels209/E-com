                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form id="myForm" class="form" action="{{ route('admin.product.store')}}" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                                            @csrf
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group" style="margin-top: 10px;">
                                                            ...
                                                            <select class="form-control js-example-basic-multiple" name="brand_id" multiple="multiple" id="js-example-basic-multiple">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="product" class="form-control " placeholder="Product Name" name="product_name" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="description">Product Short Details *</label>
                                                            <input type="text" id="shortdetails" class="form-control " name="shortdescription" >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="summernote-code description" name="longdescription" id="longdescription" ></textarea>
                                                        </div>
                                                    </div>
                                               ...
                                               <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="checkbox" data-on="On" data-off="Off" checked data-toggle="toggle" name="status">
                                                    </div>
                                                </div>
                                                   <div class="col-md-4">
                                                       <div class="form-group">
                                                           <label for="">Featured</label>
                                                           <input type="checkbox" data-on="On" data-off="Off" checked data-toggle="toggle" name="is_featured">
                                                       </div>
                                                   </div>
                                                   <div class="col-md-4">
                                                       <div class="form-group">
                                                           <label for="">New Arrival</label>
                                                           <input type="checkbox" data-on="On" data-off="Off"  data-toggle="toggle" name="is_new_arrival">
                                                       </div>
                                                   </div>
                                               </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="sprice" class="form-control " placeholder="Selling Price" name="sprice" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="name">Cost Price *</label>
                                                            <input type="text" id="cprice" class="form-control " placeholder="Cost Price" name="cprice" >
                                                        </div>
                                                    </div>
                                                </div>
