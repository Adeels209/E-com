                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="coupon_name" class="form-control cat_name" placeholder="Coupon Name" name="coupon_name" value="{{ $coupon->coupon_name }}" >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="coupon_number" class="form-control cat_name" placeholder="Coupon Number" name="coupon_no" value="{{ $coupon->coupon_no }}" >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="discount" class="form-control cat_name" placeholder="Discount " name="discount" value="{{ $coupon->discount }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" class="dropify" id="file"  data-height="200" name="image" data-default-file="{{URL::to($coupon->image)}}" />
                                                        </div>
                                                    </div>
                                                </div>
