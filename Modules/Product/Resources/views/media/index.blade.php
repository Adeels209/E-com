        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">Products Images</h3>
            ...
            <div class="row grid-margin">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title"><i class="fa fa-image"></i> Product Image</h4>
                            <p class="card-text">
                            </p>
                            <div id="lightdiv">
                                <div id="lightgallery" class=" lightGallery" style="position: relative;">
                                    @foreach($product->images as $image)
                                        <a data-id="{{$image->id}}" href="{{URL::to($image->large_image)}}" class="image-tile  specific-image">
                                            ...
                                            <img style="margin-left: 40px!important; margin-top: 30px; margin-right: 70px!important; object-fit: contain; object-position: center"  width="400" height="200" src="{{URL::to($image->large_image)}}" alt="image">
                                        </a>
                                    @endforeach
                                </div>
                            </div>
                ...
                init: function() {
                    this.on("success", function(file, response) {
                        if(response.status == -200){
                            swal("OHHHHH","Your cannot have more then 4 images for a product","error")
                        }
                        var base_url = window.location.origin;
                        console.log(base_url);
                        console.log(response.product_Image.small_image);
                        var image='<a href="'+base_url+'/'+response.product_Image.large_image+'" class="image-tile  specific-image" data-id="'+response.product_Image.id+'"> <span onclick="delFunction('+response.product_Image.id+', event)" data-id="'+response.product_Image.id+'" style="position: absolute; margin-top: 39px; margin-right: -36px !important; padding-left: 47px; object-fit:contain; object-position: center  " id="close" class="close abc" >&times;</span> <img style="margin-left: 40px!important; margin-top: 30px; margin-right: 70px!important; object-fit:contain; object-position: center  "  width="400" height="200"  src="'+base_url+'/'+response.product_Image.large_image+'" alt="image"> </a>';
